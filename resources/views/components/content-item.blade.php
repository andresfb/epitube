...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        <a href="#">
            ...
            @if($item->is_hd)
                <span class="bg-red-100 text-red-800 text-sm font-semibold me-1 px-1 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300">HD</span>
            @endif
                {{ $item->title }}
            </h5>
        </a>
        <p class="mt-4 font-normal text-gray-700 dark:text-gray-400">
            <span class="bg-gray-100 text-gray-800 text-xs font-medium inline-flex items-center me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-gray-400 border border-gray-500">
        ...
        @foreach($item->tags as $tag)
            <a href="#" class="bg-yellow-100 hover:bg-yellow-200 text-yellow-800 text-sm font-medium px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-yellow-400 border border-yellow-400 inline-flex items-center justify-center">
                {{ $tag }}
            </a>
        @endforeach
        </div>
